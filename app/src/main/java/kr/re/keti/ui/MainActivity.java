            ...
            switch (v.getId()) {
                ...
                case R.id.btnControl_Green: {
                    if (((ToggleButton) v).isChecked()) {
                        ...
                        System.out.println("애니메이션 시간: " + lottie_light_animation.getDuration());
...
//                            lottie_air_animation.setProgress((Float) animation.getAnimatedValue());
//                        }
//                    });
//                    animator.start();
                    if (((ToggleButton) v).isChecked()) {
                        lottie_air_animation.resumeAnimation();
                        lottie_light_animation.setProgress(0.1f);
                        lottie_air_animation.setVisibility(View.VISIBLE);
                        System.out.println("애니메이션 시간: " + lottie_air_animation.getDuration());
